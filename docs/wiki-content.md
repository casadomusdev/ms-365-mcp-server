...
Er kann sowohl zum **Nachschlagen** (z.B. “was habe ich heute im Kalender?”) als auch zum **aktiven Bearbeiten** (z.B. Mails verschicken, Meetings erstellen) verwendet werden.
...
- **Spezifische E‑Mail in der Vorschau anzeigen**  

  Beispiel: zeig mir eine sichere Textvorschau der Mail „Projektplan“, die ich gestern von alice@example.com bekommen habe.

- **Kompletten Inhalt einer E‑Mail lesen (HTML oder Text)**  

  Beispiel: hole den vollständigen HTML-Inhalt der E-Mail „Rechnung März“, die heute um 10 Uhr eingegangen ist, damit ich alles lesen kann.

- **Lange E‑Mail zusammenfassen**  

  Beispiel: hol die Nachricht „Onboarding Infos“ von HR und gib mir eine kurze Zusammenfassung der wichtigsten Punkte.
...
- **Bestimmte E‑Mail löschen**  

  Beispiel: lösche die E-Mail „Newsletter März“ aus meinem Postfach.

- **E‑Mail ins Archiv verschieben**  

  Beispiel: verschiebe die Nachricht „Ticket #4821 beantwortet“ in meinen Archiv-Ordner.

- **Alle Anhänge einer Nachricht auflisten**  

  Beispiel: liste alle Anhänge der Nachricht „Projektplan“ mit Namen und Größen auf.
...
- **Vorbereiteten Entwurf versenden**  
  ...
  Beispiel: sende den E-Mail-Entwurf „Projektstatus“ jetzt ab.
...
- **E-Mail in einen bestimmten Ordner verschieben**  
...
- **Spezifische Nachricht aus freigegebenem Postfach anzeigen**  

  Beispiel: zeig mir eine Textvorschau der E-Mail „Urgent Ticket“ aus dem freigegebenen Postfach support@testfirma.de.
